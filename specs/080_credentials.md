...
- 2026-09-26 — [090](090_workflow_files.md): setting a credential reloads workflows, so one that failed only because its `creds.NAME` wasn't set starts working without anyone touching a file.
