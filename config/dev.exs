...
config :purple_flow, PurpleFlowWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "cgFN2IipdnXC6OxqrqqPlcGpv0Fu7w3ytWzG+Yy/4dSL95ghDaZeXghDCvkOocPp",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:purple_flow, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:purple_flow, ~w(--watch)]}
  ]
...
config :purple_flow, dev_routes: true
